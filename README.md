...
A clean, extensible, **Docker‑first** system for detecting **data drift** & **concept drift** in ML pipelines, triggering **auto‑retraining**, tracking **model versions**, and sending **alerts**. Comes with a realistic **30‑day synthetic stream** that injects both feature and label drift.
